...
const Validation = require('./star-validator')
const app = express()
const chain = new Blockchain()


// Function to validate bitcoin wallet address
validateAddressParameter = async (req, res, next) => {
  try {
    const starValidation = new Validation(req)
...
// Function to validate wallet signature
...
// Function to validate the new star request or purchase
...
// Compression can significantly reduce the bytes transfered through the wire. 
app.use(compression())
...
/**
 * @description: Web API post endpoint validates request with JSON response.
 */
...
/**
 * @description: Web API post endpoint validates message signature with JSON response.
 */
...
/**
 * @description: Star registration Endpoint
 */
...
/**
 * @description: Get star block by star block height with JSON response.
 */
...
/**
 * @description: Get star block by wallet address (blockchain identity) with JSON response.
 */
...
/**
 * @description: Get star block by hash with JSON response.
 */
